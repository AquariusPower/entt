...
struct Utils {
    ...
    static auto meta(hashed_string name, const Node *curr) {
...
public:
    ...
    inline MetaData * data(const char *str) const ENTT_NOEXCEPT {
        return internal::Utils::meta(hashed_string{str}, node->data);
    }
    ...
    inline MetaFunc * func(const char *str) const ENTT_NOEXCEPT {
        return internal::Utils::meta(hashed_string{str}, node->func);
    }
